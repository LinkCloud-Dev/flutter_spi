...
public class FlutterSpiPlugin: NSObject, FlutterPlugin, SPIDelegate {

    private static var _instance: FlutterSpiPlugin = FlutterSpiPlugin()

  var client = SPIClient()
  var spiChannel = FlutterMethodChannel()

    static var current: FlutterSpiPlugin {
        return _instance
    }

  public static func register(with registrar: FlutterPluginRegistrar) {
    let channel = FlutterMethodChannel(name: "flutter_spi", binaryMessenger: registrar.messenger())
    let instance = FlutterSpiPlugin()
